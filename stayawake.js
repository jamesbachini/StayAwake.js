...
const stayAwakeModule = {
	...
	init: function() {
		...
		if (typeof document.hidden !== 'undefined') {
			...
			this.stayAwakeVideo.setAttribute('hidden', 'msHidden');
			this.stayAwakeVideo.setAttribute('visibilitychange', 'msvisibilitychange');
    } else if (typeof document.webkitHidden !== 'undefined') {
    	this.stayAwakeVideo.setAttribute('hidden', 'webkitHidden');
